...
<body id="top">
    ...
    <!-- home
    ================================================== -->
<section id="contactis" class="s-contactis target-section" data-parallax="scroll" data-image-src="images/bg/black-mirror.jpg" data-natural-width=1920 data-natural-height=1080 data-position-y=center">
...
<div class="row contactis-content" data-aos="fade-up">
            ...
            <div class="contactis-primary">
                <form name="contactisForm" id="contactisForm" method="post" action="" novalidate="novalidate"><br>
					...
					<div class="debajoimagen3"><?php $ut->sexo($datos["gender"]); ?></div>
					<br>
                    <div class="debajoimagen2">known for:</div>
					<div class="debajoimagen3">fight club, inglorious basterds, se7en, world war z, fury, 12 years a slave, ocean's eleven, the curious case of benjamin button</div>
					<br>
                    <div class="debajoimagen2">you've watched:</div>
					<div class="debajoimagen3"><ul class="skill-bars">
                    <li>
            ...
            <div class="contactis-secondary">
                <div class="contactis-info">
                        <p><img src=https://image.tmdb.org/t/p/w500<?php echo $datos["profile_path"]  ?> srcset=https://image.tmdb.org/t/p/w500<?php echo $datos["profile_path"]  ?>, 
                    images/suburbicon.jpg 500w"
                    sizes="(max-width: 1000px) 100vw, 1000px" alt="Film Cover"></p>
                </div> <!-- end contactis-info -->
				<div class="debajoimagen"><?php echo $ut->nacimientopais($datos["place_of_birth"]) ?></div><br>
				<div class="debajoimagen"><?php if (!empty($datos["birthday"])) { echo $ut->fechaesp($datos["birthday"]); } ?></div><br>
