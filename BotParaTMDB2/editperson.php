...
<!--- basic page needs
    ================================================== -->
<meta charset="utf-8">
<title>MyMovieDB | Edit " <?php echo $datos["name"] ?> "</title>
		...
		<div class="row section-header" data-aos="fade-up">
			<div class="col-full">
				<h1 class="display-2 display-2--light"><div class="form-field">
						<input name="link" type="text" id="link" placeholder="<?php echo $datos["name"]; ?>"
		...
		<div class="row contactis-content" data-aos="fade-up">
			...
			<div class="contactis-primary">
				<form name="contactisForm" id="contactisForm" method="post"
					...
					<button class="full-width btn--primary" name="insertfilm"
							...
							type="submit">DELETE PERSON</button>
				</form>
			...
			<div class="contactis-secondary">
				...
				<div class="debajoimagen"><div class="form-field">
						<input name="link" type="text" id="link" placeholder="USA"
							value="" minlength="2" required="" aria-required="true"
							class="full-width">
					</div></div>
				<br>
				<div class="debajoimagen"><div class="form-field">
						<input name="link" type="text" id="link" placeholder="<?php if (!empty($datos["birthday"])) { echo $ut->fechaesp($datos["birthday"]); } ?>"
							value="" minlength="2" required="" aria-required="true"
							class="full-width">
					</div></div>
				<br>
				<div class="debajoimagen"><div class="form-field">
						<input name="link" type="text" id="link" placeholder="<?php if (!is_null($datos["deathday"])) { echo $ut->fechaesp($datos["deathday"]); } ?>"
							value="" minlength="2" required="" aria-required="true"
							class="full-width">
					</div></div>
			</div>
